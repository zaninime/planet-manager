import { decode } from 'app/utils/lampId';
...
export const applyTempColor = (lampId, { white, red, green, blue }) =>
    saveGenericLampId(lampId, ofStatus.buildUpdate(white, red, green, blue));
